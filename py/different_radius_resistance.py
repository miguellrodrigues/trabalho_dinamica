...
r = np.linspace(12.5, 100, 1000)  # raio do bico (m)
...
fig1.set_xlabel('Raio do cone (cm)')
fig1.set_ylabel('Alcance (m)')
fig1.plot(r, real_part_thr, label='Alcance horizontal')
plt.savefig('images/air_resistance/alcances_horizontais_raio.png', dpi=300)

ax, fig2 = plt.subplots()
fig2.set_title('Alcances verticais')
fig2.set_xlabel('Raio do cone (cm)')
fig2.set_ylabel('Alcance (m)')
fig2.plot(r, theorical_vertical_ranges, label='Alcance vertical')

plt.savefig('images/air_resistance/alcances_verticais_raio.png', dpi=300)
plt.show()
